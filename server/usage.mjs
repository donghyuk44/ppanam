 ...
 */
export function recordUsage(team, actor, round, msg) {
  const u = msg?.usage ?? {};
  const row = {
...
export function todayUsage(team, now = new Date()) {
  ...
  return { date: today, turns: rows.length, inputTokens, outputTokens, costUsd };
}
