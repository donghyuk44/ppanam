...
// 대표 화면 자(bossOk, bosswords.js)와 같은 원칙 — **막지 않는다, 표시만 붙인다**. 낱말표는 하영이 만든다(teams/marketing/out/insider-words.md 로
// 가정 — 파일이 없으면 아무것도 안 걸린다, 지어내지 않는다). 순수 함수뿐 — 파일 읽기는 bus.mjs 몫.
