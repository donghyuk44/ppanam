...
글 유진(경영 A1, 09-16 10:xx) — 톰이 맞다고 해야 정본. 근거는 09-15 00:00Z 이후 총괄실 Read 기록(적다 — 톰은 읽기보다 말이 많았다, 점검 3-3).
...
- `teams/dev/decisions.md` (456줄 · 164KB) — 결정 정본. **전문 금지** — `grep -n '^<번호>\. '` 로 그 결정 줄만. 새 결정은 끝에 붙인다.
...
- `decisions.md`(164KB)·`docs/event-schema.md`(998줄 · 133KB · 절 13)·`점검-0916.md`·`독립검수-0916.md`(318줄 · 30KB · 절 24) — 번호·절로만.
...
- `teams/hq/out/인수인계-0914.md`·`인수인계-0915.md`·`나리-인수인계-0914.md`·`따라가기.md` — 지난 인수인계. 지금 상태는 상황판·작업 보드가 정본.
