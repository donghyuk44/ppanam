...
- `teams/marketing/out/opsroom-words.md` (654줄 · 절 12) — 낱말 사전 정본. 전문이 아니라 절을 찾고 그 절만(`Read offset/limit`). 낱말 하나 찾을 땐 `grep -n '<낱말>'`. 새 낱말은 0-3 표준어 잣대부터.
...
- `opsroom-words.md`(103KB)·`screen-text-frames.md`(31KB)·`opsroom-content-2.md`(32KB)·`screen-30s-test.md`(25KB) — 절 제목(`^## `)으로 좁혀서만. 사전 한 판을 통째로 읽으면 그 턴 예산의 반이 간다.
